...
import 'package:ecommerce/features/ui/widgets/custom_elevated_button.dart';
    ...
    return BlocListener<RegisterViewModel,AuthStates>(
      ...
      listener: (context, state) {
        if (state is AuthLoadingState) {
          ...
          DialogUtils.hideLoading(context);
          DialogUtils.showMessage(context: context, message: 'Register successfully',title: 'Success',posActionName: 'Ok');
        }
      },
      child: Scaffold(
